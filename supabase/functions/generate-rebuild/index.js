...
export async function generateRebuild(req) {
    ...
    try {
        ...
        const { resume_id, targetRole, roleTrack, sourceText, run_id } = body;
        ...
        if (!resume_id)
            throw new Error("Missing resume_id for rebuild context");
        ...
        if (resume_id !== 'NEW') {
            ...
            if (checkError && checkError.code !== 'PGRST116')
                throw checkError; // PGRST116 is 'not found'
