  ...
  return (
    <div className="relative w-full aspect-square md:aspect-video bg-[#0D0D14] rounded-[3.5rem] border border-white/5 overflow-hidden shadow-2xl group">
      ...
      <div className="absolute bottom-8 left-8 font-mono text-[9px] text-slate-600 space-y-1 opacity-50 group-hover:opacity-100 transition-opacity">
         <p className="flex items-center gap-2"><div className="w-1 h-1 rounded-full bg-green-500" /> ATS Compatibility Verified</p>
         <p className="flex items-center gap-2"><div className="w-1 h-1 rounded-full bg-blue-500" /> Auto-Deployment Active</p>
         <p className="flex items-center gap-2"><div className="w-1 h-1 rounded-full bg-slate-500" /> Responses Monitored...</p>
      </div>
