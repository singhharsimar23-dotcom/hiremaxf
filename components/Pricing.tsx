...
const PlanCard: React.FC<PlanCardProps> = ({ plan, currentPlan, onSelect, isEliteAnimating, animationComplete }) => {
  ...
  return (
    ...
    >
        ...
        {isElite ? (
          ...
          <div className="flex flex-col gap-1">
            ...
            {plan.priceComparison && (
              <p className="text-[9px] font-bold text-slate-700 uppercase tracking-wider mt-1 opacity-80">
                {plan.priceComparison}
              </p>
            )}
          </div>
      ...
      {plan.note && (
        <p className="text-[9px] font-black text-slate-800 uppercase tracking-widest mb-6 text-center">{plan.note}</p>
      )}

      <div className="mt-auto">
        {isElite6M && (
          <p className="text-center text-[9px] font-black text-slate-600 uppercase tracking-widest mb-3">
...
export const Pricing: React.FC<PricingProps> = ({ setPlan, setView, currentPlan }) => {
  ...
  const plans = [
    {
      ...
      bullets: [
        'Resume analysis',
        'See major problems in your resume',
        'Basic screening signals'
      ],
    ...
    },
    {
      ...
      price: '$24',
      subLabel: 'per month',
      valueStatement: 'Fix your resume and skill gaps properly',
      bullets: [
        'Unlimited resume rebuilds',
    ...
    },
    {
      ...
      price: '$49',
      subLabel: 'per month',
      valueStatement: 'Apply smarter, not blindly',
      bullets: [
        'Everything in Pro',
        'Signal Hub access',
        'Market outlook and trends',
        'Hidden hiring signals',
        'Role timing guidance',
        'Priority processing'
      ],
  ...
  return (
    <div className="max-w-[1400px] mx-auto py-24 px-10 animate-in fade-in duration-500 relative">
      ...
      <div className="mb-24">
        <h3 className="text-[10px] font-black text-slate-700 uppercase tracking-[0.4em] mb-12 text-center">What each level helps you do</h3>
      ...
      <div className="mt-32 text-center pb-12">
         <p className="text-[10px] font-black text-slate-800 uppercase tracking-[0.8em]">Professional Evaluation Standard v5.0</p>
      </div>
    </div>
  );
};
