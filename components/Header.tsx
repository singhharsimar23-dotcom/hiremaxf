      ...
      <div className="flex items-center gap-6 lg:gap-8">
        ...
        <nav className="hidden lg:flex items-center gap-1 overflow-x-auto custom-scrollbar pr-4">
          ...
          <NavLink
            ...
            icon={<Eye size={18} className="opacity-70 text-blue-400" />}
          />
        ...
        <div className="fixed inset-0 z-[150] xl:hidden animate-in fade-in duration-300">
          ...
          <div className="absolute top-0 right-0 w-80 h-full bg-[#0F1117] border-l border-[#2D313D] p-6 shadow-2xl flex flex-col animate-in slide-in-from-right duration-500">
            ...
            <div className="flex flex-col gap-2">
              ...
              <NavLink label="Outlook" active={currentView === 'career-intelligence'} onClick={() => { setView('career-intelligence'); setMobileMenuOpen(false); }} icon={<TrendingUp size={18} />} isLocked={!isElite} />
              <NavLink label="Jobs For You" active={currentView === 'preview'} onClick={() => { setView('preview'); setMobileMenuOpen(false); }} icon={<Eye size={18} />} />
              <NavLink label="Applications" active={currentView === 'applications'} onClick={() => { setView('applications'); setMobileMenuOpen(false); }} icon={<Zap size={18} />} isLocked={!isElite} />
